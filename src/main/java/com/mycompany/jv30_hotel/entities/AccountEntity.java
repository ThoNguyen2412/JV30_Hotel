...
public class AccountEntity implements Serializable {
    ...
    public AccountEntity(int id, String email, String password, String address, String fullName,
            String status, int voteHotel, Date birhDate, List<AccountRoleEntity> accountRoles,
            List<NotificationEntity> notificationEntities, List<CommentEntity> commentEntities,
