                                        ...
                                        <tr> 
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-primary " style="color: whitesmoke; width: 100px" 
                                                    ...
                                                    Detail</button>
                                                    <c:if test="${(booking.status != 'DONE' ) && ( bookingo.status != 'IN' ) }">
                                                    <button class="btn btn-danger " style="color: whitesmoke; width: 100px" 
                                                            onclick="location.href = '<c:url value="/user/cancelBooking/${booking.id}"/>'">
                                                        Cancel</button>
                                                    </c:if>
                                            </td>
                                        </tr>
